...
<div class="col-md-12 col-sm-12 col-lg-12">
  <div class="panel">
    ...
    <h4><center><strong><i class="fa fa-cog"></i> Quản Lý BOT Cảm Xúc</strong></center> </h4></div>
...
$from = ($trang - 1) * 20;
if($_SESSION['type'] == 'admin'){
$sqr = mysql_query("SELECT * FROM `khachhang` LIMIT ".$from.",20");
}
else{
  $sqr = mysql_query("SELECT * FROM `khachhang` WHERE useradd = '".$_SESSION['username']."' LIMIT ".$from.",20");
}
        ...
        ?>
          <tr>
            ...
            <td>
              <?php echo checklivetk($tri['token']);?>
            </td>
            <td>
              <?php echo checkliveck($tri['cookie']);?>
            </td>
            <td>
              <a href="/post/edit.php?sua=<?php echo $tri['id']; ?>"> <span class="label label-info">Sửa</span></a>
            </td>
          </tr>
        <?php
          }

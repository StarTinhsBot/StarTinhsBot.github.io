...
<div class="panel">
    <div class="panel-heading"><i class="fa fa-line-chart"></i>  Thống kê hiện có <?php
      ...
      $select = mysql_query("SELECT * FROM `khachhangcmt` WHERE useradd = '".$_SESSION['username']."'");
...
$member = mysql_query("SELECT * FROM `khachhangcmt` WHERE useradd = '".$_SESSION['username']."' ORDER BY id DESC LIMIT 10"); 
//Lấy cảm xúc
...
<script type="text/javascript">   
  $('form').submit(function(e){
        ...
        var tien = <?php echo $setting['tiencmt']; ?>;
        var phithem = 0;
        ...
        $.post('../post/cmt.php',$(this).serialize()).done(function(data){
           alert(data);

...
//THem vào Database
      ...
      mysql_query("UPDATE `user` SET `tien`= '".$conlai."' WHERE `id` = '".$_SESSION['id']."'");
      mysql_query("INSERT INTO `khachhangcmtimg` (`user_id`,`image`,`name`, `fb_dtsg`, `cookie`, `useradd`, `time`, `timemua`, `timeadd`, `battatcmt`,`noidungcmt`,`token` ) VALUES ('".$id."', '".$anh."', '".$name."', '".$fb_dtsg."', '".$cookie."', '".$_SESSION['username']."', '".time()."',  '".$thoigian."', '".date("Y-m-d h:i:sa")."','".$battatcmt."','".$noidungcmt."', '".$token."')");
